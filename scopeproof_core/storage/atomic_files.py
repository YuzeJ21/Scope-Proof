        ...
        for component in absolute.parts[1:]:
            ...
            try:
                ...
                try:
                    ...
                    pass
                # A failed first metadata capture leaves ownership ambiguous on the
                # portable backend. Do not retry and misattribute a replacement path;
                # the outer cleanup can remove only directories with captured identity.
                metadata = os.lstat(current)
                if created_here:

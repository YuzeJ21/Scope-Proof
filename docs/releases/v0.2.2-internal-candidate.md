...
- Source distributions explicitly exclude tracked `.scopeproof` local validation state.
- The evidence matrix preserves all six audit columns in a horizontally reachable mobile data grid.
